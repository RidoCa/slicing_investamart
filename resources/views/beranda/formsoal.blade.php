...
<body>
  ...
  <div class="main" id="banner">
    <img class="img3" src="{{url('img/utama/pertanyaan/profilresiko.png')}}" style="margin-left: -1%; margin-top: 23%;"
      alt="infestnow">
    <p style="margin-top: -38%">Pengen wujudin itu semua kamu harus berinvestasi yang baik dan benar sesuai dengan
      profil resiko kamu.</p>
    <p style="margin-top: -25%; font-weight: 900">Udah tau belum profil resiko kamu?</p>
    <p style="margin-top: -20%; margin-bottom: 20px; color: #ED1E79">ikutan <b>quiz.invernow.id</b> <br> dan dapatkan
      Hadiah Investasi reksadana</p> <br><br>
    <a href="/yolo/info" class="btn-primary" style="letter-spacing: 8px; font-size: 17px ">Next ></a><br><br>
  </div>
